...
This repository documents my journey learning Bitcoin, open-source development, and Bitcoin engineering through:

- Btrust Builders Mastering Bitcoin Cohort
- BitDevs Malawi (supporting mentorship)
- Self-study and technical experiments
- Open-source contribution preparation

## Goals

- Understand Bitcoin fundamentals deeply
- Learn how Bitcoin software works
- Build public proof of work
- Develop open-source contribution skills
- Prepare to contribute to Bitcoin-related projects
